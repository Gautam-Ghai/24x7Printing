...
const navigation = [
    ...
    { name: 'Working', href: '#working', current: false },
                                    ...
                                    <div className="flex space-x-4">
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className="text-lg md:text-2xl px-3 hover:text-primary"
                                            >
                                                {item.name}
                                            </a>
                                        ))}
                        ...
                        <div className="space-y-1 px-2 pt-2 pb-3 flex flex-col">
                            {navigation.map((item) => (
                                <Disclosure.Button
                                    ...
                                    href={item.href}
                                    aria-current={item.current ? 'page' : undefined}
                                    className="text-lg md:text-2xl px-3 py-2 hover:text-primary"
                                >
                                    {item.name}
                                </Disclosure.Button>
                            ))}
