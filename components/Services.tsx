            ...
            <div className='container mx-auto py-8'>
                <div className='bg-ImgColor m-4 p-8 rounded-xl'>
                    ...
                    <div className='flex flex-wrap justify-evenly items-center text-left'>
                        <div className='p-4 lg:p-8 bg-bgColor shadow-lg m-2 h-72 w-72 lg:h-96 lg:w-96 rounded-lg flex flex-col justify-center items-center'>
                            ...
                            <h3 className='mt-4 font-open text-lg lg:text-2xl font-medium text-textColor'>Printing services based on your preferred size, colour and quantity. ulk orders also available on request.</h3>
                        </div>
