        ...
        <div className='grid grid-cols-12 gap-4'>
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col p-4">
            ...
            <div className='flex m-4'>
              ...
              <Link href={"mailto:printtogo247@gmail.com"} >
                <h3 className='cursor-pointer ml-4 font-open text-lg md:text-2xl font-medium text-textColor py-4'>printtogo247@gmail.com</h3>
              </Link>
            </div>
            <div className='flex m-4'>
              <div className='h-16 w-16 bg-primary text-bgColor rounded-full grid place-items-center'>
