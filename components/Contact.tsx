      ...
      <div className='container mx-auto'>
        ...
        <div className='grid grid-cols-12 gap-4'>
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col p-4">
            <Reveal duration={0.5} className='flex m-4'>
              <>
                ...
                <h3 className='ml-4 font-open text-lg md:text-2xl font-medium text-textColor py-4'>778-651-3138</h3>
              </>
            </Reveal>
            ...
            <Reveal duration={0.5} className='flex m-4'>
              <>
                ...
                <h3 className='cursor-pointer ml-4 font-open text-lg md:text-2xl font-medium text-textColor py-4'>
                  <a href={"mailto:printtogo247@gmail.com"} target="_blank" rel="noopener noreferrer">
                    printtogo247@gmail.com
                  </a>
                </h3>
              </>
            </Reveal>
            <Reveal duration={0.5} className='flex m-4'>
              <>
                ...
                <h3 className='cursor-pointer ml-4 font-open text-lg md:text-2xl font-medium text-textColor py-4'>
                  <a href={'https://maps.app.goo.gl/Wv7s3xtVNQDtAzYj6'} target="_blank" rel="noopener noreferrer"> Miller Avenue, Coquitlam </a>
                </h3>
              </>
            </Reveal>
          </div>
